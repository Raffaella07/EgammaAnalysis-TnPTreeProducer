...
#
submitVersion = "2024-05-27" # add some date here
doL1matching  = False
isAOD = False
...
#  elif era=='2024': return 'https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions23/Cert_Collisions2023_366442_370790_Golden.json'
...
eraMC  = '2022'
submitWrapper('BToKJPsi_postEE', '/BuToKJPsi_JPsiToEE_SoftQCD_TuneCP5_13p6TeV_pythia8-evtgen/Run3Summer22EEMiniAODv4-130X_mcRun3_2022_realistic_postEE_v6-v2/MINIAODSIM', eraMC)

eraData       = '2018'

#submitWrapper('Run2024C_0v1_ECAL_R_HCAL_DI', '/EGamma0/Run2024C-ECAL_R_HCAL_DI-v1/MINIAOD', eraData)
#submitWrapper('Run2024C_1v1', '/EGamma1/Run2024C-ECAL_R_HCAL_DI-v1/MINIAOD', eraData)
#submitWrapper('Run2023C_1v1', '/EGamma1/Run2024C-PromptReco-v1/MINIAOD', eraData)
#submitWrapper('Run2023D_0v1', '/EGamma0/Run2024D-PromptReco-v1/MINIAOD', eraData)
#submitWrapper('Run2023D_1v1', '/EGamma1/Run2024D-PromptReco-v1/MINIAOD', eraData)
#submitWrapper('Run2023E_0v1', '/EGamma0/Run2024E-PromptReco-v1/MINIAOD', eraData)
#submitWrapper('Run2023E_1v1', '/EGamma1/Run2024E-PromptReco-v1/MINIAOD', eraData)

#submitWrapper('DY_LO', '/DYto2L_M-50_TuneCP5_13p6TeV_pythia8/Run3Winter24MiniAOD-KeepSi_133X_mcRun3_2024_realistic_v8-v2/MINIAODSIM', eraMC)
