...
#    el_dEtaSeeOut       = cms.string("deltaEtaSeedClusterTrackAtCalo"),
    ...
    el_noIsoMVA94XV2     = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Fall17NoIsoV2Values"),
    el_IsoMVA94XV2     = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Fall17IsoV2Values"),
    el_IsoMVA_RunIIIWinter22   = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2RunIIIWinter22IsoV1Values"),
    el_noIsoMVA_RunIIIWinter22  = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2RunIIIWinter22NoIsoV1Values"),
...
## super cluster quantities
    ...
    ph_sc_phi       = cms.string("superCluster.phi"),
